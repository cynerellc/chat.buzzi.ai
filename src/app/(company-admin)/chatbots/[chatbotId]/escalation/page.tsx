  ...
  useEffect(() => {
    if (chatbot) {
      setFormData({
        ...
        maxTurnsBeforeEscalation: chatbot.behavior?.maxTurnsBeforeEscalation ?? 5,
        autoEscalateOnSentiment: chatbot.behavior?.autoEscalateOnSentiment ?? false,
        sentimentThreshold: chatbot.behavior?.sentimentThreshold ?? 30,
      });
    }
  }, [chatbot]);
