...
function buildResponse(chatbotId: string, config: ChatWidgetConfig, companySlug: string, createdAt: Date, updatedAt: Date): WidgetConfigResponse {
  return {
    ...
    agentBubbleColor: config.agentBubbleColor || null,
...
/**
 * GET /api/company/chatbots/[chatbotId]/widget
...
export async function GET(request: NextRequest, context: RouteContext) {
  try {
    ...
    return NextResponse.json({
      config: buildResponse(chatbotId, config, company.slug, chatbot.createdAt, chatbot.updatedAt),
    });
  } catch (error) {
...
/**
 * PATCH /api/company/chatbots/[chatbotId]/widget
...
export async function PATCH(request: NextRequest, context: RouteContext) {
  try {
    ...
    if (body.userBubbleColor !== undefined) updatedChatConfig.userBubbleColor = body.userBubbleColor || undefined;
    if (body.overrideAgentColor !== undefined) updatedChatConfig.overrideAgentColor = body.overrideAgentColor;
    if (body.agentBubbleColor !== undefined) updatedChatConfig.agentBubbleColor = body.agentBubbleColor || undefined;
    ...
    return NextResponse.json({
      config: buildResponse(chatbotId, finalConfig, company.slug, chatbot.createdAt, updated.updatedAt),
    });
  } catch (error) {
